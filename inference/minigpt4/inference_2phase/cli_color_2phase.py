                    ...
                    for image_file in tqdm(images):
                        ...
                        while True:
                            ...
                            if len(re.findall(r'\{\}', question)) == 3:
                                ...
                                if count==1:
                                    inp = ("[vqa] Solve the problem based on the analysis above. Answer with the option's letter from the given choices directly. " + q).format(challenge, label, mislabel)
                            else:
                                if count==0:
                                    inp = question.format(label, mislabel)
                                if count==1:
                                    inp = ("[vqa] Solve the problem based on the analysis above. Answer with the option's letter from the given choices directly. " + q).format(label, mislabel)
