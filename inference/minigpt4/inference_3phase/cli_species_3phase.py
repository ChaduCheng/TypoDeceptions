...
prefixs = ["Focus on the visual aspects of the image, including colors, shapes, composition, and any notable visual themes. Provide a detailed visual description of the image to answer the following question. ",]
                    ...
                    for image_file in tqdm(images):
                        ...
                        while True:
                            ...
                            if len(re.findall(r'\{\}', question)) == 3:
                                ...
                                if count==1:
                                    inp = "[vqa] Based on your previous description, please delve deeper into the visual details of the image and include any subtle details or elements that were not covered in your initial description to answer the following question. " + q
                                    inp = inp.format(challenge, label, mislabel)
                                if count==2:
                                    inp = "[vqa] Solve the problem based on the analysis above. Answer with the option's letter from the given choices directly. " + q
                                    inp = inp.format(challenge, label, mislabel)
                            else:
                                if count==0:
